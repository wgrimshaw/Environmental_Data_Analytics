...
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # default fills by columns
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # now fill the matrix by rows
matrix2
...
matrix1[c(12, 14)] #
matrix1[c(12:14)] #
matrix1[2:4, 1:3] # subset rows 2 to 4 and columns 1 to 3
...
dataframe1[1:2] # pulls columns 1 and 2, not elements 1 and 2
dataframe1[c("ID","Passed")] # columns with names ID and Passed
dataframe1$Color # 
...
> ANSWER: allows you to choose from the different columns of dataframe1
