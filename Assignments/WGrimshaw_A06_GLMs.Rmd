...
> ANSWER: Studies were conducted in different years for different neonicotinoid chemicals (Kruskal-Wallace; chi-squared = 134.15, df = 8, p < 0.001).
...
> ANSWER: Temperature = -6.46 + 0.01(year) + 0.04(day number) - 1.95(depth)
> This model explains 74% of the observed variance.
...
> ANSWER: There is an interaction between depth and lakename in predicting temperature. Together, depth and lakename explain 78.6% of temperature variance.
...
```{r}
#16
ggplot(NTL.July, aes(x = depth, y = temperature_C, color = lakename)) +
